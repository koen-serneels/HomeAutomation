		...
		return new DimmerBuilder() {
			{
				...
				outputGroupAddressesForSwitchLedControl("1/3/2");
				outputGroupAddressesSwitchUpdate("1/3/5");

				precenseOperated("1/3/6");

				inputGroupAddressForOnOffOverride("1/3/4");
				inputGroupAddressForAbsoluteDimValue("14/0/17");
				inputGroupAddressForAbsoluteDimValueOverride("14/0/18");
			}
		}.build();
	}
}
