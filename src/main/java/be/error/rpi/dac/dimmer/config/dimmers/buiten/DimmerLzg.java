		...
		return new DimmerBuilder() {
			{
				...
				outputGroupAddressesForActorSwitchingOnAndOff("1/4/0");
				outputGroupAddressesForVisualisationStatusFeedback("15/0/15");
				...
				precenseOperated("1/4/6");

				inputGroupAddressForAbsoluteDimValue("14/0/14");
				inputGroupAddressForAbsoluteDimValueOverride("14/0/19");
			}
		}.build();
	}
}
